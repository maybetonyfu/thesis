...
\begin{center}
    ...
    \begin{tabular}{ l l l }
     \textit{Mode} & \textit{Features} & \textit{Section} \\ \hline
     Basic Mode & Type Compare Tool & Section~\ref{sub:type-compare} \\ \hline
     Balanced mode & Type Compare Tool & Section~\ref{sub:type-compare} \\
     & Candidate Expression Cards & Section~\ref{sub:candidate-expression} \\  \hline
     Advanced mode & Type Compare Tool & Section~\ref{sub:type-compare} \\
     & Candidate Expression Cards & Section~\ref{sub:candidate-expression} \\
     & Deduction Steps & Section~\ref{sub:deduction-steps} \\
    \end{tabular}
    \end{center}
\end{scriptsize}
