...
Static typing, a fundamental feature embedded in the origins of programming languages, is recognized for its numerous advantages, such as bug prevention, improved code quality, and decreased maintenance costs. Nevertheless, it presents considerable challenges, including a steep learning curve and slowed development pace, leading to a preference in recent years for lightweight dynamic languages like Python and JavaScript over strict languages such as Java and C++. The distinction between relaxed and strict type-systems is more prominent in programming languages that utilise more powerful type systems like Haskell.  While the Haskell type system can eliminate many errors, paradoxically, the more bugs a type system can prevent the more confusing the type errors are and the larger the barrier to their use by non-expert programmers. This issue often leaves developers facing a ``42 moment''—a state of confusion when they encounter type errors without clear explanations. Over the years, significant efforts, including my own, have been made towards augmenting the usability of static types and type errors.
